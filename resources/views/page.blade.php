...
<body>
  ...
  <nav class="navbar navbar-default">
    <div class="container-fluid">
      <div class="logo hidden-sm hidden-xs">
        <a href=""><img src="{{ asset('images/logo.png') }}" alt="AnB logo"></a>
      </div>
  ...
  <div class="wrapper">
    <div class="wrapper-content">
      <div class="call-button hidden-m hidden-md hidden-lg">
        <a class="btn btn-primary" href="tel:06 14 99 74 00">Bel <span class="glyphicon glyphicon-earphone"></span> 06 14 99 74 00</a>
      </div>
  			<h1>{{ $page->title }}</h1>
        @if (!empty($page->image))
